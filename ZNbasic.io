...
USE_MDFILE_AS_MAINPAGE = contracts/eosiolib/mainpage.md
#---------------------------------------------------------------------------
...
PREDEFINED             = "PACKED(name)=__attribute((packed))(name)"\
                         __attribute(x)=
